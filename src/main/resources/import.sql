...
VALUES ('com', 'Games', 'First Game', 'Alladin', NULL, NULL, 1, 130),
  ...
  ('net', 'Multimedia', 'Amazon inc.', 'Amazon', NULL, NULL, 3, 400),
  ('net', 'Productivity', 'First Debugger', 'JDebugger', NULL, NULL, 4, 1000),
  ('io', 'Tools', 'Ebay inc.', 'Ebay', NULL, NULL, 5, 320),
  ('io', 'Tools', 'Java IDE', 'Intellij IDEA', NULL, NULL, 15, 500),
  ('io', 'Health', 'Health practice', 'Facebook', NULL, NULL, 5, 220),
  ('com', 'Lifestyle', 'Casual desc', 'Casual', NULL, NULL, 25, 550),
  ('net', 'Multimedia', 'Virtual reality', 'Google', NULL, NULL, 25, 990),
  ('io', 'Health', 'LinkedIn inc.', 'LinkedIn', NULL, NULL, 2, 330),
  ('com', 'Tools', 'Odnoklassniki inc.', 'Odnoklassniki', NULL, NULL, 20, 100),
  ('io', 'Health', 'RSS inc.', 'RSS', NULL, NULL, 15, 380),
  ('net', 'Lifestyle', 'Skype inc.', 'Skype', NULL, NULL, 8, 1500),
  ('io', 'Lifestyle', 'Social Network', '3D glasses', NULL, NULL, 10, 700),
  ('com', 'Tools', 'Messager', 'Twitter', NULL, NULL, 15, 400),
